# meta-openrex
FEDEVEL Yocto Project for OpenRex (STST 20191030)
...
Copy and paste this into your Linux host machine 
    ...
    <manifest>
      ...
      <remote fetch="git://github.com/adveecfw" name="adveecfw"/>
     
      <project remote="adveecfw" revision="jethro" name="meta-openrex" path="sources/meta-openrex">
